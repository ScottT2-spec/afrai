...
const MODEL_CATALOG: readonly ModelDefinition[] = [
  ...
  // ── SambaNova ────────────────────────────────────────────────────
  {
    ...
    cost: { inputPer1k: 0.0001, outputPer1k: 0.0001 },
  ...
  },
  {
    ...
    cost: { inputPer1k: 0.0006, outputPer1k: 0.0006 },
    maxContextTokens: 128_000,
    maxOutputTokens: 4_096,
  ...
  },
  {
    ...
    cost: { inputPer1k: 0.001, outputPer1k: 0.001 },
    maxContextTokens: 128_000,
    maxOutputTokens: 8_192,
    complexityThreshold: 0.5,
    allowedTiers: new Set(['growth', 'enterprise']),
  ...
  },
  {
    ...
    cost: { inputPer1k: 0.0008, outputPer1k: 0.0008 },
    maxContextTokens: 128_000,
    maxOutputTokens: 8_192,
    complexityThreshold: 0.4,
    allowedTiers: new Set(['growth', 'enterprise']),
  ...
  // ── Groq ────────────────────────────────────────────────────────
  {
    ...
    cost: { inputPer1k: 0.00059, outputPer1k: 0.00079 },
    maxContextTokens: 128_000,
  ...
  },
  {
    ...
    cost: { inputPer1k: 0.00005, outputPer1k: 0.00008 },
    maxContextTokens: 128_000,
    maxOutputTokens: 8_192,
    complexityThreshold: 0.0,
    allowedTiers: new Set(['free', 'starter', 'growth', 'enterprise']),
